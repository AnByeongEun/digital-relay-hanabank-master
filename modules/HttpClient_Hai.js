...
module.exports = class HttpClient {
  constructor(name) {
    ...
    instance.interceptors.request.use(config => {
      ...
      config.headers['hai-access-channel'] = 'AICC';
      config.headers['hai-access-token'] = '0000000000';
      config.headers['hai-device-guid'] = '0000000000';
      config.headers['hai-device-ipv6adr'] = '192.168.0.56';
      config.headers['hai-device-macadr'] = '0000000000666666';
      config.headers['hai-dialog-session-id'] = '0000000000';
      config.headers['hai-request-guid'] = '0000000000';
      config.headers['hai-service-group'] = 'AICC';
